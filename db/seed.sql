...
insert into positions (id, company_id, name, level, base_salary_min, base_salary_max) values
  ('00000000-0000-0000-0000-0000000000f1','00000000-0000-0000-0000-00000000c001','CEO','C-level',60000000,120000000),
  ('00000000-0000-0000-0000-0000000000f2','00000000-0000-0000-0000-00000000c001','Head of Department','Director',35000000,60000000),
  ('00000000-0000-0000-0000-0000000000f3','00000000-0000-0000-0000-00000000c001','Team Lead','Manager',20000000,35000000),
  ('00000000-0000-0000-0000-0000000000f4','00000000-0000-0000-0000-00000000c001','Senior Specialist','Senior',15000000,25000000),
  ('00000000-0000-0000-0000-0000000000f5','00000000-0000-0000-0000-00000000c001','Specialist','Mid',10000000,16000000),
  ('00000000-0000-0000-0000-0000000000f6','00000000-0000-0000-0000-00000000c001','Junior','Junior',7000000,11000000)
on conflict do nothing;
...
insert into employees (id, company_id, full_name, email, department_id, position_id, base_salary, status) values
  ('00000000-0000-0000-0000-0000000000e1','00000000-0000-0000-0000-00000000c001','Nguyễn Văn A','ceo@bizos.demo',null,'00000000-0000-0000-0000-0000000000f1',80000000,'active'),
  ('00000000-0000-0000-0000-0000000000e2','00000000-0000-0000-0000-00000000c001','Trần Thị B','hr@bizos.demo','00000000-0000-0000-0000-00000000d005','00000000-0000-0000-0000-0000000000f2',45000000,'active'),
  ('00000000-0000-0000-0000-0000000000e3','00000000-0000-0000-0000-00000000c001','Lê Văn C','cfo@bizos.demo','00000000-0000-0000-0000-00000000d006','00000000-0000-0000-0000-0000000000f2',50000000,'active'),
  ('00000000-0000-0000-0000-0000000000e4','00000000-0000-0000-0000-00000000c001','Phạm Thu D','sales.head@bizos.demo','00000000-0000-0000-0000-00000000d001','00000000-0000-0000-0000-0000000000f2',48000000,'active'),
  ('00000000-0000-0000-0000-0000000000e5','00000000-0000-0000-0000-00000000c001','Hoàng Minh E','mkt.head@bizos.demo','00000000-0000-0000-0000-00000000d002','00000000-0000-0000-0000-0000000000f2',45000000,'active'),
  ('00000000-0000-0000-0000-0000000000e6','00000000-0000-0000-0000-00000000c001','Đỗ Quỳnh F','ops.head@bizos.demo','00000000-0000-0000-0000-00000000d003','00000000-0000-0000-0000-0000000000f2',42000000,'active'),
  ('00000000-0000-0000-0000-0000000000e7','00000000-0000-0000-0000-00000000c001','Vũ Thanh G','cs.head@bizos.demo','00000000-0000-0000-0000-00000000d004','00000000-0000-0000-0000-0000000000f2',38000000,'active')
on conflict do nothing;
...
insert into kpis (id, company_id, code, name, level, weight, target_frequency, unit) values
  ('00000000-0000-0000-0000-0000000000b1','00000000-0000-0000-0000-00000000c001','REV','Doanh thu tháng','company',1,'monthly','VND'),
  ('00000000-0000-0000-0000-0000000000b2','00000000-0000-0000-0000-00000000c001','GP','Gross Profit','company',1,'monthly','VND'),
  ('00000000-0000-0000-0000-0000000000b3','00000000-0000-0000-0000-00000000c001','NP','Net Profit','company',1,'monthly','VND'),
  ('00000000-0000-0000-0000-0000000000b4','00000000-0000-0000-0000-00000000c001','RET','Retention','company',1,'monthly','%')
on conflict do nothing;

-- Dept KPIs
insert into kpis (id, company_id, code, name, level, owner_department_id, parent_kpi_id, weight, target_frequency, unit) values
  ('00000000-0000-0000-0000-000000000b10','00000000-0000-0000-0000-00000000c001','SAL.CLOSE','Sales close rate','department','00000000-0000-0000-0000-00000000d001','00000000-0000-0000-0000-0000000000b1',0.6,'monthly','%'),
  ('00000000-0000-0000-0000-000000000b11','00000000-0000-0000-0000-00000000c001','SAL.AOV','AOV','department','00000000-0000-0000-0000-00000000d001','00000000-0000-0000-0000-0000000000b1',0.4,'monthly','VND'),
  ('00000000-0000-0000-0000-000000000b20','00000000-0000-0000-0000-00000000c001','MKT.LEADS','Qualified leads','department','00000000-0000-0000-0000-00000000d002','00000000-0000-0000-0000-0000000000b1',0.5,'monthly','lead'),
  ('00000000-0000-0000-0000-000000000b21','00000000-0000-0000-0000-00000000c001','MKT.CAC','CAC','department','00000000-0000-0000-0000-00000000d002','00000000-0000-0000-0000-0000000000b2',0.5,'monthly','VND'),
  ('00000000-0000-0000-0000-000000000b30','00000000-0000-0000-0000-00000000c001','OPS.SLA','Order SLA','department','00000000-0000-0000-0000-00000000d003','00000000-0000-0000-0000-0000000000b2',0.7,'monthly','%'),
  ('00000000-0000-0000-0000-000000000b40','00000000-0000-0000-0000-00000000c001','CS.RET','Retention','department','00000000-0000-0000-0000-00000000d004','00000000-0000-0000-0000-0000000000b4',1,'monthly','%')
on conflict do nothing;

-- 6. KPI formulas (JSONB AST)
insert into kpi_formulas (kpi_id, formula_type, definition) values
  ('00000000-0000-0000-0000-0000000000b1','composite',
    '{"op":"sum","args":[{"ref":"SAL.CLOSE"},{"ref":"SAL.AOV"},{"ref":"MKT.LEADS"}]}'::jsonb),
  ('00000000-0000-0000-0000-0000000000b2','ratio',
    '{"op":"sub","args":[{"ref":"REV"},{"ref":"COGS"}]}'::jsonb),
  ('00000000-0000-0000-0000-0000000000b3','ratio',
...
insert into kpi_targets (kpi_id, period, target_value) values
  ('00000000-0000-0000-0000-0000000000b1','2026-04',5000000000),
  ('00000000-0000-0000-0000-0000000000b2','2026-04',2000000000),
  ('00000000-0000-0000-0000-0000000000b3','2026-04',800000000)
on conflict do nothing;

insert into kpi_actuals (kpi_id, period, actual_value, completion_rate, status) values
  ('00000000-0000-0000-0000-0000000000b1','2026-04',5200000000,1.04,'green'),
  ('00000000-0000-0000-0000-0000000000b2','2026-04',1900000000,0.95,'yellow'),
  ('00000000-0000-0000-0000-0000000000b3','2026-04',720000000,0.90,'yellow')
on conflict do nothing;

-- 8. Sample tasks
insert into tasks (company_id, title, assignee_id, department_id, linked_kpi_id, priority, task_type, status, due_date) values
  ('00000000-0000-0000-0000-00000000c001','Chốt 10 đơn sales tuần này','00000000-0000-0000-0000-0000000000e4','00000000-0000-0000-0000-00000000d001','00000000-0000-0000-0000-000000000b10','high','growth','in_progress','2026-04-30'),
  ('00000000-0000-0000-0000-00000000c001','Chạy campaign TikTok mới','00000000-0000-0000-0000-0000000000e5','00000000-0000-0000-0000-00000000d002','00000000-0000-0000-0000-000000000b20','normal','growth','todo','2026-05-05'),
  ('00000000-0000-0000-0000-00000000c001','Review SLA vận hành tháng','00000000-0000-0000-0000-0000000000e6','00000000-0000-0000-0000-00000000d003','00000000-0000-0000-0000-000000000b30','normal','maintenance','review','2026-04-28')
on conflict do nothing;

-- 9. Payroll period + a few entries
insert into payroll_periods (id, company_id, period, status) values
  ('00000000-0000-0000-0000-0000000000a1','00000000-0000-0000-0000-00000000c001','2026-04','draft')
on conflict do nothing;
...
insert into payroll_entries (company_id, payroll_period_id, employee_id, base_salary, bonus_total, gross_pay, net_pay, company_cost) values
  ('00000000-0000-0000-0000-00000000c001','00000000-0000-0000-0000-0000000000a1','00000000-0000-0000-0000-0000000000e1',80000000,20000000,100000000,85000000,115000000),
  ('00000000-0000-0000-0000-00000000c001','00000000-0000-0000-0000-0000000000a1','00000000-0000-0000-0000-0000000000e4',48000000,12000000,60000000,51000000,70000000)
on conflict do nothing;
